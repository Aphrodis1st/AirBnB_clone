#!/usr/bin/python3
"""The implementation of the Test Base Model module"""
...
def test_type_of_id_is_str(self):
    ...
    def test_created_at_is_datetime(self):
        """A function that checks that the attribute 'created_at' is a datetime object"""
        b = BaseModel()
        self.assertTrue(type(b.created_at) is datetime)

    def test_updated_at_is_datetime(self):
        """A function that checks that the attribute 'updated_at' is a datetime object"""
        b = BaseModel()
        self.assertTrue(type(b.updated_at) is datetime)

    def test_two_models_different_created_at(self):
        """A function that checks that the attribute 'created_at' of 2 models are different"""
        b1 = BaseModel()
        sleep(0.02)
        b2 = BaseModel()
        sleep(0.02)
    ...
    def test_args_unused(self):
        """A function that checks that the attribute 'args' is not used"""
        b = BaseModel(None)
        self.assertNotIn(None, b.__dict__.values())

    def test_that_created_at_equals_updated_at_initially(self):
        """A function that checks that create_at == updated_at at initialization"""
        b = BaseModel()
        self.assertEqual(b.created_at, b.updated_at)

    def test_that_save_func_update_update_at_attr(self):
        """A function that checks that save() method updates the updated_at attribute"""
        b = BaseModel()
        b.save()
    ...
    def test_if_to_dict_returns_dict(self):
        """A function that checks if BaseModel.to_dict() returns a dict object"""
        b = BaseModel()
        self.assertTrue(type(b.to_dict()) is dict)

    def test_if_to_dict_returns_class_dunder_method(self):
        """A function that checks if BaseModel.to_dict() contains __class__"""
        b = BaseModel()
        self.assertTrue("__class__" in b.to_dict())

    def test_that_created_at_returned_by_to_dict_is_an_iso_string(self):
        """A function that checks that created_at is stored as a str obj in ISO format"""
        b = BaseModel()
    ...
    def test_that_updated_at_returned_by_to_dict_is_an_iso_string(self):
        """A function that checks that updated_at is stored as a str obj in ISO format"""
        b = BaseModel()
        self.assertEqual(b.to_dict()["updated_at"], b.updated_at.isoformat())

    def test_if_to_dict_returns_the_accurate_number_of_keys(self):
        """A function that checks that to_dict() returns the expected number of keys/values"""
        b = BaseModel()
    ...
    def test_when_kwargs_passed_is_empty(self):
        """	A function that checks that id, created_at and updated_at are 
			automatically generated if they're not in kwargs
        """
        my_dict = {}
        b = BaseModel(**my_dict)
        self.assertTrue(type(b.id) is str)
    ...
    def test_when_kwargs_passed_is_not_empty(self):
        """A function that checks that id, created_at and updated_at are created from kwargs"""
    ...
    def test_when_args_and_kwargs_are_passed(self):
        """	A function that checks when args and kwargs are passed
			and when BaseModel should ignore args
		"""
        dt = datetime.now()
        dt_iso = dt.isoformat()
    ...
    def test_when_kwargs_passed_is_more_than_default(self):
        """	A function that checks that BaseModel does not break when kwargs 
    ...
    def test_new_method_not_called_when_dict_obj_is_passed_to_BaseModel(self):
        """	A function that tests that storage.new() is not called when a 
			BaseModel obj is created from a dict object
        """
        my_dict = {"id": uuid4(), "created_at": datetime.utcnow().isoformat(),
                   "updated_at": datetime.utcnow().isoformat(),
                   "name": "Firdaus"}
    ...
    def test_that_save_method_updates_updated_at_attr(self):
        """A function that checks that save() method updates 'updated_at' attribute"""
        b = BaseModel()
        sleep(0.02)
    ...
    def test_that_save_can_update_two_or_more_times(self):
        """A function that checks that the save() method updates 'updated_at' two times"""
        b = BaseModel()
        sleep(0.02)
        temp_update = b.updated_at
        b.save()
    ...
    def test_save_update_file(self):
        """A function that checks if the file is updated when 'save' is called"""
        b = BaseModel()
        b.save()
    ...
    def test_that_to_dict_contains_correct_keys(self):
        """A function that checks whether to_dict() returns the expected key"""
    ...
    def test_to_dict_contains_added_attributes(self):
        """A function that checks that new attributes are also returned by to_dict()"""
        b = BaseModel()
        attrs = ["id", "created_at", "updated_at", "__class__"]
        b.name = "Firdaus"
    ...
    def test_to_dict_output(self):
        """A function that checks the output returned by to_dict()"""
        b = BaseModel()
        dt = datetime.now()
        b.id = "12345"
    ...
    def test_to_dict_with_args(self):
        """A function that checks that TypeError is returned when argument is passed to to_dict()"""
        b = BaseModel()
